...
const PM_ORDER: PM[] = ["pnpm", "bun", "npm", "yarn"];
...
function BunIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 80 70">
      ...
      <path d="M73 35.7a21.67 21.67 0 0 0-.8-5.78c-2.73 33.3-43.35 34.9-59.32 24.94A40 40 0 0 0 38 63.24c19.3 0 35-12.35 35-27.54Z" style={{ fill: "#f6dece" }} />
      <path d="M24.53 11.17C29 8.49 34.94 3.46 40.78 3.45A9.29 9.29 0 0 0 38 3c-2.42 0-5 1.25-8.25 3.13-1.13.66-2.3 1.39-3.54 2.15-2.33 1.44-5 3.07-8 4.7C8.69 18.13 3 26.62 3 35.7v1.19c6.06-21.41 17.07-23.04 21.53-25.72Z" style={{ fill: "#fffefc" }} />
      ...
      <g>
        <path d="M45.05 43a8.93 8.93 0 0 1-2.92 4.71 6.81 6.81 0 0 1-4 1.88A6.84 6.84 0 0 1 34 47.71 8.93 8.93 0 0 1 31.12 43a.72.72 0 0 1 .8-.81h12.34a.72.72 0 0 1 .79.81Z" style={{ fill: "#b71422" }} />
        <path d="M34 47.79a6.91 6.91 0 0 0 4.12 1.9 6.91 6.91 0 0 0 4.11-1.9 10.63 10.63 0 0 0 1-1.07 6.83 6.83 0 0 0-4.9-2.31 6.15 6.15 0 0 0-5 2.78c.23.21.43.41.67.6Z" style={{ fill: "#ff6164" }} />
      ...
      <g>
        ...
        <path d="M25.7 38.8a5.51 5.51 0 1 0-5.5-5.51 5.51 5.51 0 0 0 5.5 5.51Zm24.77 0A5.51 5.51 0 1 0 45 33.29a5.5 5.5 0 0 0 5.47 5.51Z" style={{ fillRule: "evenodd" }} />
        <path d="M24 33.64a2.07 2.07 0 1 0-2.06-2.07A2.07 2.07 0 0 0 24 33.64Zm24.77 0a2.07 2.07 0 1 0-2.06-2.07 2.07 2.07 0 0 0 2.04 2.07Z" style={{ fill: "#fff", fillRule: "evenodd" }} />
      </g>
    </svg>
  );
}
...
function YarnIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 518 518">
      <path d="M259 0c143 0 259 116 259 259S402 518 259 518 0 402 0 259 116 0 259 0z" />
      <path
...
const ICONS: Record<PM, (props: SVGProps<SVGSVGElement>) => React.ReactElement> = {
  pnpm: PnpmIcon,
  bun: BunIcon,
  npm: NpmIcon,
  yarn: YarnIcon,
  ...
  return (
    <div className="flex flex-col rounded-lg border border-zinc-200 overflow-hidden">
      ...
      <div
        ...
        className="flex items-center gap-2.5 px-4 py-2.5 font-mono text-sm transition-colors hover:bg-zinc-50 cursor-pointer"
      >
        ...
        <svg
          ...
          className={`ml-auto text-zinc-300 shrink-0 transition-opacity ${hovered || copied ? "opacity-100" : "opacity-0"}`}
        >
          {copied ? (
