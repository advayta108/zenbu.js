// Note: This was previously a verbatim copy of orchestrator's PluginUpdateModal.
// Now lives in the agent-manager plugins view; the orchestrator's copy stays
// in init for the kernel-binary update path.
...
import {
  ...
  DialogHeader,
  DialogTitle,
} from "#zenbu/init/src/renderer/components/ui/dialog"
import { Button } from "#zenbu/init/src/renderer/components/ui/button"
import { useEvents, useRpc } from "#zenbu/init/src/renderer/lib/providers"
