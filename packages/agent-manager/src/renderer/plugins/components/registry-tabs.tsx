import type { DiscoverKey } from "../lib/types"
...
// Top tab strip for the plugins screen. Each tab toggles which subset of
// the registry the list below filters down to.
