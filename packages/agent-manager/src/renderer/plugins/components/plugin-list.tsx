...
// Left column — searchable list of plugin cards. Internal visual helpers
// (PluginCard, Thumbnail, StatusLabel, search/spinner icons, install row)
// stay co-located since none of them render anywhere else.
